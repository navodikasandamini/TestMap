...
lyr_SriLankaDistricts_1.set('fieldLabels', {'shapeName': 'inline label - visible with data', 'shapeISO': 'no label', 'shapeID': 'no label', 'shapeGroup': 'no label', 'shapeType': 'no label', });
